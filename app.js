...
//
// 중요:
// 23:00 ~ 01:00 같은 자정 넘는 계획도 계산
//
// 23:00 -> 01:00
// 기존 방식: 60 - 1380 = 음수 → 계산 안 됨
// 수정 방식: 120분
//
// ======================================================
...
// ======================================================
// 36. Supabase Auth 상태 변경 감지
// ======================================================
//
// 로그인 / 로그아웃 직후 상태를 확실히 반영
//
// ======================================================
